...
# ── Routers ───────────────────────────────────────────────────────────────────
from routers import data, export, chat, deck, exec_summary, construction_detail, cement_specific, ma_deals, world_view, company_capacity, carbon_problem, transition_readiness, green_future
...
app.include_router(transition_readiness.router, prefix="/transition-readiness", tags=["transition-readiness"])
app.include_router(green_future.router, prefix="/green-future", tags=["green-future"])
