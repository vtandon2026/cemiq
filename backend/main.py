...
# ── Routers ───────────────────────────────────────────────────────────────────
from routers import data, export, chat, deck, exec_summary, construction_detail, cement_specific, ma_deals, world_view, company_capacity, carbon_problem, transition_readiness
...
app.include_router(transition_readiness.router, prefix="/transition-readiness", tags=["esg"])
