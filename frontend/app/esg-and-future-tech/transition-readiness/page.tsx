...
import type { MatrixRow, KPIs } from "@/components/charts/transitionTypes";
...
export default function TransitionReadinessPage() {
  ...
  const load = useCallback(() => {
    ...
    apiFetch("/transition-readiness/all", {
      ...
      setHeatmapData(res.heatmap ?? null);
      setKpis(kpi);
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", gap: 16 }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {kpis && (
              <div style={{
                ...
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.85)", fontWeight: 700, letterSpacing: "0.06em", marginBottom: 6 }}>
                  EXECUTIVE INSIGHT
                </div>
                <div style={{ color: "#fff" }}>
                ...
                <div style={{ marginTop: 8, paddingTop: 8, borderTop: "1px solid rgba(255,255,255,0.18)", fontSize: 10.5, fontStyle: "italic", color: "rgba(255,255,255,0.80)", lineHeight: 1.4 }}>
            ...
            {/* Technology Adoption Heatmap — full width */}
            <div style={{ background: "#fff", border: "1px solid #e9ecef", borderRadius: 10, padding: 16, boxShadow: "0 1px 4px rgba(0,0,0,0.05)", marginBottom: 14 }}>
              ...
              {loading ? <LoadingSpinner height={240} /> : (
                <AdoptionHeatmap data={heatmapData} height={240} />
              )}
            </div>
          ...
          <div style={{ width: 288, flexShrink: 0 }}>
            <ChatPanel
              ...
              dataScope="transition_readiness"
